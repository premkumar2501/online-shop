...
const Candle = () => {
  ...
  const {
    state: { candle,filterCandle,fliterHolder },
    dispatch,
  ...
  const favorite = (value) => {
    dispatch({ type: "candleFav", payload: value });
  };
  const sortedProduct = () => {
    var temp = candle;
    if(filterCandle){
      temp = temp.filter(e=>e.brand === 'candle')
      return temp
    }
    if(fliterHolder){
      temp = temp.filter(e=>e.brand === 'holder')
    }
    return temp
  };
                ...
                <div className="checked">
                  ...
                  <input
                    ...
                    onChange={() => 
                      ...
                      checked={filterCandle}
                  ></input>
                  <label for="vehicle1"> candles</label>
                  <br></br>
                  <input
                    type="checkbox"
                    id="vehicle1"
                    ...
                    checked={fliterHolder}
                  ></input>
                  <label for="vehicle1"> Candle Holders</label>
                  <br></br>
                </div>
                <br></br>
                <hr></hr>
