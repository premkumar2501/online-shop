...
const Printer = () => {
  ...
  const { state : {filterHp, filterCanon, filterAroma,printer}, dispatch } = useContext(stateContext);
  ...
  const favorite =(value) =>{
    dispatch({type:'PrinterFav',payload:value})
  }
  
  const sortedProduct = () =>{
    var temp = printer;
    if(filterHp){
      temp = temp.filter(e => e.brand === 'hp')
      return temp
    }
    if(filterCanon){
      temp = temp.filter(e => e.brand === 'canon')
      return temp;
    }
    return temp;
  }
      ...
      /> */}
                ...
                <div className="checked">
                  ...
                  {/* {sortedProduct().map((value, index) => {
                    return (
                      <div key={index}>
                        ...
                        ></input>
                        <label for="vehicle1">{value.brand}</label>
                      </div>
                    );
                  })} */}
                  <input
                  ...
                  <input
                    ...
                    checked={filterCanon}
                  ></input>
                  <label for="vehicle1"> Canon</label>
                  <br></br>
                </div>
                <hr></hr>
                <div className="checked">
