...
const Cycle = () => {
  ...
  const {
    state: { cycle,filterHero,filterUrban },
    dispatch,
  ...
  const favorite = (value) => {
    dispatch({type:'cycleFav',payload:value});
  }

  const sortedProduct = () =>{
    var temp = cycle;
    if(filterHero){
        temp = temp.filter(e=>e.brand === 'hero')
        return temp
    }
    if(filterUrban){
      temp = temp.filter(e => e.brand === 'urban')
      return temp
    }
    return temp
  }
      ...
      /> */}
                ...
                <div className="checked">
                  ...
                  <input
                    ...
                    checked={filterUrban}
                  ></input>
                  <label for="vehicle1"> Urban Terrain</label>
                  <br></br>
                  </div>
                <br></br>
                <hr></hr>
